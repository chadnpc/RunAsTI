...
#!/usr/bin/env pwsh
# .SYNOPSIS
#   RunAsTI buildScript v0.1.0
# .DESCRIPTION
#   A custom build script for the module RunAsTI
# .LINK
#   https://github.com/chadnpc/RunAsTI/blob/main/build.ps1
# .EXAMPLE
#   ./build.ps1 -Task Test
...
# .NOTES
#   Author   : chadnpc
#   Copyright: Copyright © 2025 chadnpc. All rights reserved.
#   License  : MIT
